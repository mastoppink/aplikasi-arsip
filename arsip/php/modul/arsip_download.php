...
$hariIni = date("d-m-Y");
header("Content-Disposition: attachment; filename=DataBerkas-".$_POST['tahun_berkas']."-".$hariIni.".xls");
header("Expires: 0");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
header("Cache-Control: private",false);
$q = mysql_query("select * from v_arsip where tahun_berkas='".$_POST['tahun_berkas']."' limit 65000");
echo "<table>";
echo "<tr>
	<th>No Berkas</th>
	<th>NPWP</th>

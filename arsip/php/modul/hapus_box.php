...
<div class="col-md-3">
<h4>Form</h4>
<form id="form_hapus_npwp" method="POST" action="php/modul/proses_hapus_box.php">
...
<div class="col-md-9">
	...
	<tbody>
		<?php
			$tahun = date("Y");
			$q = mysql_query("select distinct(npwp) as npwp,no_berkas,nama_wp,no_box,alasan,tanggal,tbl_berkas_dihapus_daluarsa.jenis_berkas as jenis, tbl_jenis.nama_jenis as jenis_berkas,masa,tahun_berkas,user_id from tbl_berkas_dihapus_daluarsa, tbl_jenis where tbl_jenis.id = jenis_berkas order by tanggal DESC");
			$i = 1;
...
<form method="POST" action="php/modul/export_hapus_daluarsa.php">
<input type="hidden" name="no_box" value="<?php $_GET['no_box']; ?>">

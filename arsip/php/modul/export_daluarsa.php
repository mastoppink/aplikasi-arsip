...
$hariIni = date("d-m-Y");
$tahun_ini  = date("Y");
header("Content-Disposition: attachment; filename=DataBerkas-Daluarsa-".$hariIni.".xls");
header("Expires: 0");
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
header("Cache-Control: private",false);
$q = mysql_query("select * from v_arsip where tahun_berkas < '".($tahun_ini-10)."' limit 65000");
echo "<table>";
echo "<tr>
	<th>No Berkas</th>
	<th>NPWP</th>
